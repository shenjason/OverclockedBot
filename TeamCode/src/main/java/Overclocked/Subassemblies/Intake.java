...
public class Intake {
    ...
    Timer pickupTimer; Timer transferTimer; Timer autoAngleTimer; Timer detectionTimer; Timer pickupModeTimer; Timer prepickuptimer;

    boolean canSwitchToDetection; boolean isPickup; boolean isprepickup;
    ...
    public void   setArmPose(int pose){
        ...
        switch (pose){
            ...
            case (IntakeArmPose.TRANSFER):
                armRight.setPosition(0.38);
                armLeft.setPosition(0.38);

                wristLeft.setPosition(0.25);
                wristRight.setPosition(0.25);

                wristMid.setPosition(0.367);

                break;
            case (IntakeArmPose.DETECTION):
                armRight.setPosition(0.48);
...
//                wristMid.setPosition(IntakeConstants.deg0_wrist_pos);
    ...
    public void update(Telemetry telemetry){
        ...
        if (isprepickup && prepickuptimer.getElapsedTimeSeconds() > 0.1){
            isprepickup = false;
