...
public class AutoSample extends OpMode {
    ...
    private final Pose scorePoseClose = new Pose(15.5,  126, Math.toRadians(-45));
    private final Pose scorePose = new Pose(15.5,  126, Math.toRadians(-45));
    private final Pose secondPickup = new Pose(24.8, 121.8, Math.toRadians(0));
    private final Pose thirdPickup = new Pose(24.2, 128, Math.toRadians(0));
    private final Pose forthPickup = new Pose(39, 122.3, Math.toRadians(90));
    ...
    void buildPaths(){
        firstScorePath = follower.pathBuilder()
                .addPath(new BezierLine(new Point(start), new Point(scorePoseClose)))
                .setLinearHeadingInterpolation(start.getHeading(), scorePoseClose.getHeading()).build();
